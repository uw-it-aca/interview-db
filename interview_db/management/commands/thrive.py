...
from interview_db.db_dao import get_article_by_slug, create_article_data
from django.conf import settings
from interview_db.views import render_article_html, render_category_links
from interview_db.models import Article
import json
import os
import shutil
...
class Command(BaseCommand):
    APP_BASE_DIR = settings.BASE_DIR + '/interview_db/'
    STATIC_OUTPUT_DIR = APP_BASE_DIR + 'static/interview_db_output/'
    ARTICLE_OUTPUT_DIR = APP_BASE_DIR + 'templates/interview_db_output/'
    ...
    IMAGE_REL_DIR = 'interview_db_output/images/'

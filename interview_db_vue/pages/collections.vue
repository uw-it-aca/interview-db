    ...
    <template #content>
      ...
      <div class="card">
        <div class="row g-0">
          ...
          <div class="col-md-7">
            <div class="card-body">
              <h5 class="card-title">Collection Topic</h5>
              <p class="card-text">Some question about the collection topic</p>
              <p class="card-text"><router-link to="/">Read full collection ></router-link></p>
            </div>
          </div>
        </div>
      </div>

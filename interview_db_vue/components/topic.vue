// topic.vue // shows all student stories for one collection topic
        ...
        <div class="col-sm-12 col-lg-7 mx-auto d-flex flex-column">
          <div class="row mb-4">
            <div class="col-6 justify-content-start">
              ...
              >
                {{ stories.length + (currentPage - 1) * perPage }} of
                {{ totalCount }} Results
              </p>
              <p
          ...
          <div v-else-if="stories.length == 0">
            <p class="card-columns justify-content-end fw-bold fs-5 mb-5">
  ...
  methods: {
    async loadData() {
      ...
      const infoResponse = await axios.get(
        "/api/collections/" + this.$route.params.id + "/info/"
      );

...
export default defineConfig({
  ...
  build: {
    ...
    outDir: "./interview_db/static/", // relative path to django's static directory
    assetsDir: "interview_db/assets", // default ('assets')... this is the namespaced subdirectory of outDir that vite uses
